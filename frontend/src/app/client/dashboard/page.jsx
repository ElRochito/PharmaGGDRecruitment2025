...
export default function ClientDashboard() {
	...
	return (
			<div class="group not-prose relative overflow-hidden sm:overflow-visible">
				<div class="p-8 @container relative overflow-auto rounded-lg bg-white outline outline-white/5 dark:bg-gray-950/50 dark:inset-ring dark:inset-ring-white/5 group-data-dragging:before:absolute group-data-dragging:before:inset-0">
